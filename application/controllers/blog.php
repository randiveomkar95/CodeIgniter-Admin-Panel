...
class Blog extends CI_Controller {
       ...
       public function edit_blog($uid){

        $this->load->model("blog_model"); 
        $data["fetch_single_data"] = $this->blog_model->fetch_single_data($uid);
        ...
        {  
                ...
                {  
                    //insert data
                     $this->blog_model->update_data($data,$uid); 
        ...
        {  
             ...
             {    //return to
                ...
                public function resizeImage($filename)
                       {
                          $source_path = $_SERVER['DOCUMENT_ROOT'] . './uploads/blog/' . $filename;
                          $target_path = $_SERVER['DOCUMENT_ROOT'] . './uploads/blog/thumbnail/' . $filename;
                          $config_manip = array(
                              'image_library' => 'gd2',
         ...
         //UPDATE IMAGE:
          ...
          {  
            ...
            // redirect(base_url() . "logo"); 
                ...
                {  
                    //insert data
                     $this->blog_model->update_image_data($data,$uid); 
