...
<form method="post" action="<?php echo base_url(); ?>footer/insert" enctype="multipart/form-data">

<div class="form-group row">
<label class="col-sm-2 col-form-label">CALL US NOW:</label>
<div class="col-sm-10">
<input type="text" class="form-control max-textarea" required name="mobile" >
...
<div class="col-sm-10">
<input type="text" class="form-control max-textarea" required name="visit" >
<span class="messages"></span>
</div>
</div>
...
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="message" maxlength="255" rows="4"></textarea>  
<span class="messages"></span>
</div>
</div>
