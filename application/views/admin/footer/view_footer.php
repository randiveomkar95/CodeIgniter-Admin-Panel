...
<a href="<?php base_url(); ?>add_footer">
...
<tr>
<td><?php echo $t; ?></td>
<td><textarea rows="8" readonly style="width: 100%; text-align: justify; background-color: #ECF5FF;"><?php echo $row->mobile; ?></textarea></td>
<td><textarea rows="8" readonly style="width: 100%; text-align: justify; background-color: #ECF5FF;"><?php echo $row->visit; ?></textarea></td>
<td><textarea rows="8" readonly style="width: 100%; text-align: justify; background-color: #ECF5FF;"><?php echo ($row->message); ?></textarea></td>
<!-- <td><?php echo nl2br($row->generated_at); ?></td> -->
 <td>

<a href="<?php base_url(); ?>edit_footer/<?php $uid = $row->id; echo $uid; ?>">
 <i class='fa fa-pencil' style='font-size:25px; color:#4099FF;'></i>
    ...
    <?=anchor("footer/delete_data/".$row->id,"<i class='fa fa-trash' style='font-size:25px; color:red;'></i>",array('onclick' => "return confirm('Do you want to really delete this record??')"))?>
...
<script type="text/javascript">
    ...
    function delete(id){
       var r=confirm("Do you want to delete this?")
        if (r==true)
          window.location = url+"footer/delete_data/"+id;
        else
          return false;
        } 
</script>
