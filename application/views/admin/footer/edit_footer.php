...
<span>You can change here your website Footer content</span>
</div>
</div>
</div>
<div class="col-lg-4">
...
<li class="breadcrumb-item"><a href="#!">Footer Section</a>
</li>
<li class="breadcrumb-item">
<a href="#!">Change Footer Content</a>
</li> -->
<a href="<?php base_url(); ?>../view_footer">
...
<form method="post" action="<?php echo base_url(); ?>footer/update" enctype="multipart/form-data">




<div class="form-group row">
<label class="col-sm-2 col-form-label">CALL US NOW:</label>
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="mobile" maxlength="1500" rows="6"><?php echo ($row->mobile); ?></textarea>
<span class="messages"></span>
</div>
</div>

<div class="form-group row">
<label class="col-sm-2 col-form-label">COME VISIT US:</label>
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="visit" maxlength="1500" rows="6"><?php echo ($row->visit); ?></textarea>
<span class="messages"></span>
</div>
</div>

<div class="form-group row">
<label class="col-sm-2 col-form-label">SEND US A MESSAGE:</label>
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="message" maxlength="1500" rows="8"><?php echo ($row->message); ?></textarea>  
