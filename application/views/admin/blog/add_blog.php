...
<div class="d-inline">
<h5>Blog Section</h5>
<span>You can change here your website Blog content</span>
</div>
</div>
</div>
<div class="col-lg-4">
...
<li class="breadcrumb-item"><a href="#!">Blog Section</a>
</li>
<li class="breadcrumb-item">
<a href="#!">Change Blog Content</a>
</li> -->

<a href="<?php base_url(); ?>view_blog">
<li class="breadcrumb-item"><input type="submit" class="btn btn-primary" value="View All Blogs" name="">
</li>
</a>
</ul>
</div>
...
<div class="col-sm-10">
<input type="text" class="form-control max-textarea" required name="auther" >
<span class="messages"></span>
</div>
</div>
...
<div class="col-sm-10">
<input type="date" class="form-control max-textarea" required name="date" >
<span class="messages"></span>
</div>
</div>
...
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="content" maxlength="255" rows="10"></textarea>  
<span class="messages"></span>
</div>
</div>
