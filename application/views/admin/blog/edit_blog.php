...
<form method="post" action="<?php echo base_url(); ?>blog/update_image" enctype="multipart/form-data">
<?php  
...
<a href="<?php echo base_url(); ?>blog/update_image/<?php $uid = $row->id; echo $uid; ?>"></a>
...
<form method="post" action="<?php echo base_url(); ?>blog/update_data" enctype="multipart/form-data">
...
<div class="col-sm-10">
  <input type="hidden" name="hidden_id" value="<?php echo $row->id; ?>" />
<textarea class="form-control max-textarea"  name="auther" maxlength="255" rows="0"><?php echo nl2br($row->auther); ?></textarea>  
...
<div class="col-sm-10">
  <input type="hidden" name="hidden_id" value="<?php echo $row->id; ?>" />
<textarea class="form-control max-textarea"  name="date" maxlength="255" rows="0"><?php echo nl2br($row->date); ?></textarea>  
