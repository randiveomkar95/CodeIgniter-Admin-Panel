...
<div class="d-inline">
<h5>Gallary Section</h5>
<span>You can upload here your website Gallary Images</span>
</div>
</div>
</div>
<div class="col-lg-4">
...
<li class="breadcrumb-item"><a href="#!">Gallary Section</a>
</li>
<li class="breadcrumb-item">
<a href="#!">Add Gallary Images</a>
</li> -->
<a href="<?php base_url(); ?>view_gallary">
...
<h5>Gallary  ( Upload multiple images at a time)</h5>
<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>
</div>
<div class="card-block">

<form method="post" action="<?php echo base_url(); ?>gallary/upload_multiple" enctype="multipart/form-data">
    ...
    <div class="row">
		<div class="gallery">
			<ul>
				...
				<li>
					<img src="<?php echo base_url('./uploads/gallary/'.$file['image']); ?>" alt="" >
