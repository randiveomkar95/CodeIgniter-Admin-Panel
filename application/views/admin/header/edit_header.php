...
<span>You can change here your website Header content</span>
</div>
</div>
</div>
<div class="col-lg-4">
...
<li class="breadcrumb-item"><a href="#!">Header Section</a>
</li>
<li class="breadcrumb-item">
<a href="#!">Change Header Content</a>
</li> -->
<a href="<?php base_url(); ?>../view_header">
...
<form method="post" action="<?php echo base_url(); ?>header/update" enctype="multipart/form-data">
...
<div class="form-group row">
<label class="col-sm-2 col-form-label">CALL Support</label>
<div class="col-sm-10">
