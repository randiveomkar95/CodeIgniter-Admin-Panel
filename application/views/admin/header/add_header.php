...
<form method="post" action="<?php echo base_url(); ?>header/insert" enctype="multipart/form-data">
...
<div class="col-sm-10">
<input type="text" class="form-control max-textarea" required name="message" >  
