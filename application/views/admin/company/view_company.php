...
<a href="<?php base_url(); ?>add_company">
...
<tbody>
	<?php  
           ...
           {    $t = 0;
                ...
                {  
                    $t++;
                    $imgURL = "./uploads/company/";
                    $image = $row->image;
           ?> 
<tr>
<td><?php echo $t; ?></td>
<td><img src="<?php echo $imgURL.$image; ?>" style="height: 120px; width: 200px;" ></td>
<td><textarea rows="2" readonly style="width: 100%; text-align: justify; background-color: #ECF5FF;"><?php echo $row->name; ?></textarea></td>
<td><textarea rows="2" readonly style="width: 100%; text-align: justify; background-color: #ECF5FF;"><?php echo $row->designation; ?></textarea></td>
<td><textarea rows="8" readonly style="width: 100%; text-align: justify; background-color: #ECF5FF;"><?php echo nl2br($row->description); ?></textarea></td>
<!-- <td><?php echo nl2br($row->generated_at); ?></td> -->
 <td>

<a href="<?php base_url(); ?>edit_company/<?php $uid = $row->id; echo $uid; ?>">
 <i class='fa fa-pencil' style='font-size:25px; color:#4099FF;'></i>
    ...
    <?=anchor("company/delete_data/".$row->id,"<i class='fa fa-trash' style='font-size:25px; color:red;'></i>",array('onclick' => "return confirm('Do you want to really delete this record??')"))?>
...
<script type="text/javascript">
    ...
    function delete(id){
       var r=confirm("Do you want to delete this?")
        if (r==true)
          window.location = url+"company/delete_data/"+id;
        else
          return false;
        } 
</script>
