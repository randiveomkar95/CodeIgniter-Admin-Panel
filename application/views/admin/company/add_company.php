...
<div class="col-sm-10">
<input type="text" class="form-control max-textarea" required name="designation" >
<span class="messages"></span>
</div>
</div>
...
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="description" maxlength="255" rows="4"></textarea>  
<span class="messages"></span>
</div>
</div>
