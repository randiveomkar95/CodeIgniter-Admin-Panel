...
<span>You can change here your website company content</span>
</div>
</div>
</div>
<div class="col-lg-4">
...
<li class="breadcrumb-item"><a href="#!">Company Section</a>
</li>
<li class="breadcrumb-item">
<a href="#!">Change Company Content</a>
</li> -->
<a href="<?php base_url(); ?>../view_company">
...
<h5>Edit Company Content</h5>
<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>
</div>
<div class="card-block">


<form method="post" action="<?php echo base_url(); ?>company/update_image" enctype="multipart/form-data">
<?php  
...
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="name" maxlength="1500" rows="6"><?php echo ($row->name); ?></textarea>
<span class="messages"></span>
</div>
</div>
...
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="designation" maxlength="1500" rows="6"><?php echo ($row->designation); ?></textarea>
<span class="messages"></span>
</div>
</div>
...
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="description" maxlength="1500" rows="8"><?php echo ($row->description); ?></textarea>  
<input type="hidden" name="hidden_id" value="<?php echo $row->id; ?>" />
<span class="messages"></span>
</div>
</div>
