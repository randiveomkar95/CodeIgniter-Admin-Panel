...
<a href="<?php base_url(); ?>add_services">
<li class="breadcrumb-item"><input type="submit" style="border-radius:20px;" class="btn btn-primary" value="Add Service" name="">
</li>
</a>
...
<td><img src="<?php echo $imgURL.$image_icon; ?>" style="height: 120px; width: 200px;" ></td>
<td>
...
<a href="<?php base_url(); ?>edit_services/<?php $uid = $row->id; echo $uid; ?>">
 <i class='fa fa-pencil' style='font-size:25px; color:#4099FF;'></i>
    ...
    <?=anchor("services/delete_data/".$row->id,"<i class='fa fa-trash' style='font-size:25px; color:red;'></i>",array('onclick' => "return confirm('Do you want to really delete this record??')"))?>
