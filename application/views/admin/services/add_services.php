...
<li class="breadcrumb-item"><a href="#!">Services Section</a>
</li>
<li class="breadcrumb-item">
<a href="#!">Change Services Content</a>
</li> -->
<a href="<?php base_url(); ?>view_services">
<li class="breadcrumb-item"><input type="submit" class="btn btn-primary" value="View All Services" name="">
</li>
</a>
</ul>
</div>
...
<form method="post" action="<?php echo base_url(); ?>services/insert" enctype="multipart/form-data">
...
<div class="col-sm-10">
<input type="file" class="form-control" name="image_icon"  placeholder="Text Input Validation">  
<span class="messages"></span>
</div>
</div>
