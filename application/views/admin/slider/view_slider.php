...
<a href="<?php base_url(); ?>add_slider">
<li class="breadcrumb-item"><input type="submit" style="border-radius:20px;" class="btn btn-primary" value="Add Slider Image" name="">
</li>
</a>
...
<a href="<?php base_url(); ?>edit_slider/<?php $uid = $row->id; echo $uid; ?>">
 <i class='fa fa-pencil' title="Edit" style='font-size:25px; color:#4099FF;'></i>
</a>&nbsp;&nbsp;&nbsp;



    <?=anchor("slider/delete_data/".$row->id,"<i class='fa fa-trash' title='Delete' style='font-size:25px; color:red;'></i>",array('onclick' => "return confirm('Do you want to really delete this record??')"))?>
