...
<h5>Edit Slider Content</h5>
<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>
</div>
<div class="card-block">

<form method="post" action="<?php echo base_url(); ?>slider/update_image" enctype="multipart/form-data">
<?php  
...
<a href="<?php echo base_url(); ?>slider/update_image/<?php $uid = $row->id; echo $uid; ?>"></a>
...
<form method="post" action="<?php echo base_url(); ?>slider/update_data" enctype="multipart/form-data">
