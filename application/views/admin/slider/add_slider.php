...
<span>You can change here your website Slider content</span>
</div>
</div>
</div>
<div class="col-lg-4">
...
<li class="breadcrumb-item"><a href="#!">Slider Section</a>
</li>
<li class="breadcrumb-item">
<a href="#!">Change Slider Content</a>
</li> -->

<a href="<?php base_url(); ?>view_slider">
<li class="breadcrumb-item"><input type="submit" class="btn btn-primary" value="View All Slider Images" name="">
</li>
</a>
</ul>
</div>
...
<form method="post" action="<?php echo base_url(); ?>slider/insert" enctype="multipart/form-data">
...
<div class="form-group row">
<label class="col-sm-2 col-form-label">Slider Caption:</label>
<div class="col-sm-10">
