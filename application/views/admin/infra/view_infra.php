...
<!-- <a href="<?php base_url(); ?>edit_services/<?php $uid = $row->id; echo $uid; ?>">
 <input type="button" style="border-radius:30px;" value="Update" class="btn btn-success">
    ...
    <?=anchor("infra/delete_data/".$row->id,"<i class='fa fa-trash' style='font-size:25px; color:red;'></i>",array('onclick' => "return confirm('Do you want to really delete this record??')"))?>
