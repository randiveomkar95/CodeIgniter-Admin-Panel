...
<h5>Edit Testimonial Content</h5>
<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>
</div>
<div class="card-block">

<form method="post" action="<?php echo base_url(); ?>testimonial/update_image" enctype="multipart/form-data">
<?php  
...
<a href="<?php echo base_url(); ?>testimonial/update_image/<?php $uid = $row->id; echo $uid; ?>"></a>
...
<form method="post" action="<?php echo base_url(); ?>testimonial/update_data" enctype="multipart/form-data">
...
<div class="col-sm-10">
  <input type="hidden" name="hidden_id" value="<?php echo $row->id; ?>" />
<textarea class="form-control max-textarea"  name="designation" maxlength="255" rows="0"><?php echo nl2br($row->designation); ?></textarea>  
