...
<span>You can change here your website Testimonial content</span>
</div>
</div>
</div>
<div class="col-lg-4">
...
<li class="breadcrumb-item"><a href="#!">Testimonial Section</a>
</li>
<li class="breadcrumb-item">
<a href="#!">Change Testimonial Content</a>
</li> -->
<a href="<?php base_url(); ?>view_testimonial">
<li class="breadcrumb-item"><input type="submit" class="btn btn-primary" value="View All Testimonial" name="">
</li>
</a>
</ul>
</div>
...
<form method="post" action="<?php echo base_url(); ?>testimonial/insert" enctype="multipart/form-data">

<div class="form-group row">
<label class="col-sm-2 col-form-label">Testimonial Name:</label>
<div class="col-sm-10">
<input type="text" class="form-control max-textarea" required name="name" >
...
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="designation" maxlength="255" rows="4"></textarea>  
<span class="messages"></span>
</div>
</div>
...
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="content" maxlength="255" rows="4"></textarea>  
<span class="messages"></span>
</div>
</div>
