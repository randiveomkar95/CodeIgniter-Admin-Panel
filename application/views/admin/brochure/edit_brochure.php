...
<a href="<?php base_url(); ?>../brochure">
<li class="breadcrumb-item"><input type="submit" class="btn btn-primary" value="View Brochure" name="">
</li>
</a>
</ul>
</div>
...
<form method="post" action="<?php echo base_url(); ?>brochure/update" enctype="multipart/form-data">
<?php  
...
<label class="col-sm-2 col-form-label">Previous Brochure:</label>
<div class="col-sm-10">
<object data="<?php echo base_url();?> <?php echo $imgURL.$image; ?>" type="application/pdf">
    <iframe src="<?php echo base_url();echo $imgURL.$image; ?>"></iframe>
</object>
	<br><br>
</div>
