...
<div class="d-inline">
<h5>Brochure Section</h5>
<span>You can change here your website Brochure</span>
</div>
</div>
</div>
<div class="col-lg-4">
...
<li class="breadcrumb-item"><a href="#!">Brochure Section</a>
</li>
<li class="breadcrumb-item">
<a href="#!">Change Brochure</a>
</li>
</ul>
</div>
</div>
...
<h5>Change Brochure</h5>
<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>
</div>
<div class="card-block">

<form method="post" action="<?php echo base_url(); ?>brochure/post" enctype="multipart/form-data">

<div class="form-group row">
<label class="col-sm-2 col-form-label">Select Brochure</label>
<div class="col-sm-10">
...
<div class="col-sm-10">
<input type="submit" name="insert"  value="Upload" class="btn btn-primary m-b-0">
</div>
</div>
 ...
 <!-- <?php echo $error;?>  -->
<!--   <?php echo form_open_multipart('brochure/add');?> 
...
<script>  
 $(document).ready(function(){  
      $('#upload_form').on('submit', function(e){  
           ...
           {  
                $.ajax({  
                     url:"<?php echo base_url(); ?>brochure/add_upload",   
