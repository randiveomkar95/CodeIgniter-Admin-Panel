...
<!-- <a href="<?php base_url(); ?>add_brochure">
...
<td> <object data="<?php echo base_url();?> <?php echo $imgURL.$image; ?>" type="application/pdf">
...
<a href="<?php base_url(); ?>edit_brochure/<?php $uid = $row->id; echo $uid; ?>">
 <input type="button" style="border-radius:30px;" value="Change Brochure" class="btn btn-success">
</a>
