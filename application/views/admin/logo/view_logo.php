...
<a href="<?php base_url(); ?>edit_logo/<?php $uid = $row->id; echo $uid; ?>">
 <input type="button" style="border-radius:30px;" value="Change Logo" class="btn btn-success">
</a>
