...
<form method="post" action="<?php echo base_url(); ?>product/update_product_image" enctype="multipart/form-data">
<?php  
...
<input type="hidden" name="hidden_id1" value="<?php echo $row->title; ?>" />
...
<a href="<?php echo base_url(); ?>product/update_image/<?php $uid = $row->title; echo $uid; ?>"></a>
