...
<form method="post" action="<?php echo base_url(); ?>product/update_image" enctype="multipart/form-data">
<?php  
...
<form method="post" action="<?php echo base_url(); ?>product/update_data" enctype="multipart/form-data">
...
<div class="col-sm-10">
<textarea class="form-control max-textarea"  name="description" maxlength="255" rows="6"><?php echo nl2br($row->description); ?></textarea>  
<span class="messages"></span>
</div>
</div>
