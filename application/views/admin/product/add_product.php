...
<li class="breadcrumb-item"><a href="#!">Product Section</a>
</li>
<li class="breadcrumb-item">
<a href="#!">Change Product Content</a>
</li> -->
<a href="<?php base_url(); ?>view_product">
<li class="breadcrumb-item"><input type="submit" class="btn btn-primary" value="View All Product" name="">
</li>
</a>
</ul>
</div>
...
<form method="post" action="<?php echo base_url(); ?>product/upload_multiple" enctype="multipart/form-data">

<div class="form-group row">
<label class="col-sm-2 col-form-label">Product Title:</label>
<div class="col-sm-10">
<input type="text" class="form-control max-textarea" required name="title" >
...
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="description"  rows="8"></textarea>  
<span class="messages"></span>
</div>
</div>
<!-- 
