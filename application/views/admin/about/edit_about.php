...
<form method="post" action="<?php echo base_url(); ?>about/update_image" enctype="multipart/form-data">
<?php  
...
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="about" maxlength="1500" rows="6"><?php echo ($row->vision); ?></textarea>
<span class="messages"></span>
</div>
</div>
...
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="about" maxlength="1500" rows="6"><?php echo ($row->mission); ?></textarea>
<span class="messages"></span>
</div>
</div>
...
<div class="col-sm-10">
<textarea class="form-control max-textarea" required name="about" maxlength="1500" rows="8"><?php echo ($row->about); ?></textarea>  
<input type="hidden" name="hidden_id" value="<?php echo $row->id; ?>" />
<span class="messages"></span>
</div>
</div>
