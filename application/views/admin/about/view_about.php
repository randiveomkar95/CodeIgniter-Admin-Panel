...
<td><textarea rows="8" readonly style="width: 100%; text-align: justify; background-color: #ECF5FF;"><?php echo $row->vision; ?></textarea></td>
<td><textarea rows="8" readonly style="width: 100%; text-align: justify; background-color: #ECF5FF;"><?php echo $row->mission; ?></textarea></td>
<td><textarea rows="8" readonly style="width: 100%; text-align: justify; background-color: #ECF5FF;"><?php echo nl2br($row->about); ?></textarea></td>
<!-- <td><?php echo nl2br($row->generated_at); ?></td> -->
 <td>

<a href="<?php base_url(); ?>edit_about/<?php $uid = $row->id; echo $uid; ?>">
 <i class='fa fa-pencil' style='font-size:25px; color:#4099FF;'></i>
    ...
    <?=anchor("about/delete_data/".$row->id,"<i class='fa fa-trash' style='font-size:25px; color:red;'></i>",array('onclick' => "return confirm('Do you want to really delete this record??')"))?>
