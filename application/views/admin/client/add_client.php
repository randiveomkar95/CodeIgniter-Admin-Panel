...
<li class="breadcrumb-item"><a href="#!">Client Section</a>
</li>
<li class="breadcrumb-item">
<a href="#!">Change Client Content</a>
</li> -->

<a href="<?php base_url(); ?>view_client">
<li class="breadcrumb-item"><input type="submit" class="btn btn-primary" value="View All Client Images" name="">
</li>
</a>
</ul>
</div>
...
<form method="post" action="<?php echo base_url(); ?>client/insert" enctype="multipart/form-data">
...
<div class="col-sm-10">
<input type="text" class="form-control max-textarea"  name="name" >
<span class="messages"></span>
</div>
</div>
...
<div class="col-sm-10">
<textarea class="form-control max-textarea"  name="content" maxlength="255" rows="4"></textarea>  
<span class="messages"></span>
</div>
</div>
